		...
		<div className={css(styles.content_horizontal)}>
		    <div className={css(styles.content_vertical)}>
                ...
                <div className={css(styles.under_construction_wrapper)}>
                    <span className={css(styles.under_construction_text)}>This page is under construction at the moment, but will hold the entire case study of why and how we built this portfolio.</span>
                </div>
